...
""" [Figure 3.2]
Simplified road map of balige
"""
balige_map = UndirectedGraph(dict(
    jl_hita=dict(jl_saya=75, jl_drsutomo=300),
    jl_drsutomo=dict(jl_siliwangi=145),
    jl_saya=dict(jl_siliwangi2=100,jl_pdtleman=50),
    jl_pdtleman=dict(jl_tdpardede=500,jl_muliaraja=180,jl_banjarganjang=700),
    jl_banjarganjang=dict(jl_piereganjang=123),
    jl_8=dict(jl_bonanionan=90,jl_piereganjang=476),
    jl_bonanionan=dict(jl_sianipar=489),
    jl_siliwangi2=dict(jl_muliaraja=201,jl_siliwangi=320),
    jl_tdpardede=dict(jl_muliaraja2=289,jl_dipanjaitan=176),
    jl_dipanjaitan=dict(jl_x=185,jl_yaya=130),
    jl_yaya=dict(jl_gereja1=400,jl_a=231),
    jl_muliaraja=dict(jl_muliaraja2=651),
    jl_gereja1=dict(jl_ghmsiahaan=100),
    jl_a=dict(jl_dolok=100,jl_ghm=500),
    jl_dolok=dict(jl_ente=100),
    jl_x=dict(jl_muliaraja3=200,jl_muliaraja2=166),
    jl_muliaraja3=dict(jl_muliaraja4=500,jl_muliaraja2=155),
    jl_ghm=dict(martabak_bandit=100),
    martabak_bandit=dict(jl_cinta=312),
    jl_cinta=dict(jl_muliaraja4=200,jl_parluasan=100),
    jl_parluasan=dict(jl_sibolahotang=600),
    ))
balige_map.locations = dict(
    jl_hita=(120, 360),jl_sibolahotang=(562,560), jl_parluasan=(530, 400), jl_cinta=(500, 380),
    martabak_bandit=(460,380),
    jl_ghm=(420,380), jl_a=(380,380), jl_dolok=(380, 350),
    jl_ente=(415, 350), jl_gereja1=(300, 340), jl_yaya=(300, 380),
    jl_dipanjaitan=(270, 380), jl_x=(270, 510), jl_tdpardede=(220, 380),
    jl_muliaraja4=(250, 571), jl_muliaraja3=(240, 555), jl_muliaraja2=(220, 530),
    jl_muliaraja=(180, 510), jl_pdtleman=(170, 370),
    jl_saya=(150,450),jl_drsutomo=(50,370),jl_siliwangi=(70,510),
    jl_siliwangi2=(160,505))
...
def compare_graph_searchers():
    ...
    compare_searchers(problems=[GraphProblem('martabak_bandit', 'Bucharest', balige_map),
                                GraphProblem('Oradea', 'Neamt', balige_map),
                                GraphProblem('Q', 'WA', australia_map)],
                      header=['Searcher', 'balige_map(martabak_bandit, Bucharest)',
                              'balige_map(Oradea, Neamt)', 'australia_map'])
